                  ...
                  <v-row>
                    <v-col cols="12" md="8">
                      ...
                      <div class="text-center mt-3">
                        <v-btn rounded color="success" dark>SIGN IN</v-btn>
                      </div>
                    </v-col>
                    <v-col cols="12" md="4" class="success">
                      ...
                      <div class="text-center">
                        ...
                        <v-icon class="mr-2" >{{ link.icons }}</v-icon><span id="chat">{{ link.title }}</span>
                        </v-btn>
                      </div>
                    </v-col>
                  </v-row>
...
export default {
  ...
  data: () => ({
    ...
    loading: false,
    event: [
        { icons: 'accessibility', title: 'CREATE ACCOUNT', route: '/signup'}
    ],
    valid: true,
